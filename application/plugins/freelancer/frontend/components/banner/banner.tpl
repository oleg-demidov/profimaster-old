...
<div class="{$component}">
    <div class="{$component}-cont">
        ...
        <div class="{$component}-button">{component 'button' url={router page="user/register_master/step1"} mods="large warning" text="Стать мастером"}
        <br>Получай заказы от лучших заказчиков казнета</div>
        <div class="{$component}-button">{component 'button' url={router page="user/register_employer/reg"} mods="large primary" text="Стать заказчиком"}
