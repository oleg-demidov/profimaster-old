...
<form action="{router page='auth/login'}" method="post" class="js-form-validate js-freelancer-auth-login-form">
    {hook run='form_login_begin'}

    {* Логин *}
    {component 'field.text' label="Логин, Email или Номер" value={$sEmailOrNumber} name="email_or_number"
