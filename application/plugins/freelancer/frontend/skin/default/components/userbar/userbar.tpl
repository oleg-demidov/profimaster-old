    ...
    <div class="ls-userbar-inner ls-clearfix" style="min-width: {Config::Get('view.grid.fluid_min_width')}; max-width: {Config::Get('view.grid.fluid_max_width')};">
        ...
        <nav class="ls-userbar-nav">
            {if $oUserCurrent}
                ...
                {$createMenu[] = [ 'name' => 'blog', 'text' => {lang name='modal_create.items.blog'}, 'url' => {router page='blog/add'} ]}
                {$createMenu[] = [ 'name' => 'talk', 'text' => {lang name='modal_create.items.talk'}, 'url' => {router page='talk/add'} ]}
                {$createMenu[] = [ 'name' => 'drafts', 'text' => {lang name='topic.drafts'}, 'url' => "{router page='content/drafts'}", count => $iUserCurrentCountTopicDraft ]}
