...
class PluginFreelancer_ModuleSms extends ModuleORM
{
    ...
    public function Send(&$oSms) {
        ...
        $aParams = array_merge($aParams, Config::Get('plugin.freelancer.sms.user'));
        $aRes = $this->Response(Config::Get('plugin.freelancer.sms.urls.send'),$aParams );
