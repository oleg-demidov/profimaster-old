...
<ol>
    ...
    <li>Если указаны период и количество - привилегия действует до исчерпания количества обращений к ней пользователем, после истечения периода количество восстанавливается, до следуещего истечения периода.</li>
</ol><br>
<div>
...
<table style="margin: 5px;">
    <tr><td> <label> Период(в секундах): <input type="text" name="period"></label></td>
        <td> <label> Количество: <input type="text" name="count"></label></td></tr>
</table>
<script>
