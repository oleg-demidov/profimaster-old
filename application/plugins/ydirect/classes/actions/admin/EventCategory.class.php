...
class PluginYdirect_ActionAdmin_EventCategory extends PluginYdirect_Inherits_PluginAdmin_ActionAdmin_EventCategory
{
    ...
    public function EventCategoryRemove()
    {
         ...
         */
        $bResult = false;
        $this->Hook_Run('ydirect_before_delete_category', array('category' => $oCategory, 'bResult' => &$bResult));
        if ($bResult and $oCategory->Delete()) {
    ...
    public function EventCategoryUpdate()
    {
        ...
        if (getRequest('category_submit')) {
            ...
            if ($oCategory->_Validate()) {
                ...
                if ($oCategory->Update()) {
                    $bResult = false;
                    $this->Hook_Run('ydirect_after_save_category', array('category' => $oCategory, 'bResult' => &$bResult));
                    /**
