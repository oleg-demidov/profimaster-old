...
<form method="post">
    ...
    {capture name="keywords"}
        {if $oCategory}
            {$aKeywords = $oCategory->getCampaignOrNew()->getKeywords()}
        {/if}
        
        {component 'ydirect:n-keywords'}        
        {component 'ydirect:keywords' aKeywords=$aKeywords}
    {/capture}
    {component 'block' content=$smarty.capture.keywords}
sd
    {* URL *}
