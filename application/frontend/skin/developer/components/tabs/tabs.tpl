...
{$component = 'ls-tabs'}
{component_define_params params=[ 'activeTab', 'tabs', 'mods', 'classes', 'attributes', 'classesList' ]}
...
<div class="{$component} {cmods name=$component mods=$mods} {$classes}" {cattr list=$attributes}>
    {* Табы *}
    {component 'tabs.list' activeTab=$activeTab tabs=$tabs classes=$classesList}
