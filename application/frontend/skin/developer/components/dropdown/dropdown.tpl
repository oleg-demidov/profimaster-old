...
{component_define_params params=[ 'text', 'icon', 'activeItem', 'isSplit', 'menu', 'mods', 'classes', 'attributes','navMods', 'isSubnav' ]}
...
<div class="{$component} {cmods name=$component mods=$mods} {$classes}" {cattr list=$attributes}>
    ...
    {* Меню *}
    {component 'dropdown' template='menu' activeItem=$activeItem items=$menu mods=$navMods isSubnav = $isSubnav}
</div>
