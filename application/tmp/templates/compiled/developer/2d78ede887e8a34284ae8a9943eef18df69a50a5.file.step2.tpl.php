<?php /* Smarty version Smarty-3.1.13, created on 2018-03-14 13:53:21
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionUser/register_master/step2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18581417395aa8d4f10b58a0-50040505%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d78ede887e8a34284ae8a9943eef18df69a50a5' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionUser/register_master/step2.tpl',
      1 => 1520848488,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18581417395aa8d4f10b58a0-50040505',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5aa8d4f115e8d6_71620142',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aa8d4f115e8d6_71620142')) {function content_5aa8d4f115e8d6_71620142($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php $_tmp1=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'jumbotron','title'=>Config::Get('view.name'),'subtitle'=>Config::Get('view.description'),'titleUrl'=>$_tmp1,'classes'=>'layout-header'),$_smarty_tpl);?>
    ...
    <?php echo smarty_function_component(array('_default_short'=>"freelancer:logo"),$_smarty_tpl);?>

    <?php echo smarty_function_component(array('_default_short'=>'freelancer:breadcrumbs','list'=>array(array('number'=>1,'label'=>'Выбрать специализацию'),array('number'=>2,'label'=>'О себе'),array('number'=>3,'label'=>'Аккаунт'),array('number'=>4,'label'=>'Активация')),'current'=>2),$_smarty_tpl);?>
...
?>
    ...
    <?php echo smarty_function_component(array('_default_short'=>'freelancer:register.master.step2','oUser'=>$_smarty_tpl->tpl_vars['oUser']->value),$_smarty_tpl);?>
