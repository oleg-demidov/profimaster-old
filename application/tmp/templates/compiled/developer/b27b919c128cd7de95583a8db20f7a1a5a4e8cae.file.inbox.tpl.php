<?php /* Smarty version Smarty-3.1.13, created on 2018-03-20 18:36:34
         compiled from "/var/www/profimaster/application/frontend/skin/developer/actions/ActionTalk/inbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20040877555ab100521a73c0-83450193%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b27b919c128cd7de95583a8db20f7a1a5a4e8cae' => 
    array (
      0 => '/var/www/profimaster/application/frontend/skin/developer/actions/ActionTalk/inbox.tpl',
      1 => 1493631808,
      2 => 'file',
    ),
    'a147c065f7acdfff487f5e18623501a93fd2c30f' => 
    array (
      0 => '/var/www/profimaster/application/frontend/skin/developer/layouts/layout.user.messages.tpl',
      1 => 1493631808,
      2 => 'file',
    ),
    'f5167feb188919cf514b17dc08944d07c1b69f41' => 
    array (
      0 => '/var/www/profimaster/application/frontend/skin/developer/layouts/layout.user.tpl',
      1 => 1502701192,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '20040877555ab100521a73c0-83450193',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ab100522a9ab9_51252478',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ab100522a9ab9_51252478')) {function content_5ab100522a9ab9_51252478($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php echo smarty_function_component_define_params(array('params'=>array('mods','classes','attributes')),$_smarty_tpl);?>
    ...
    <?php ob_start();?><?php echo smarty_function_router(array('page'=>'talk'),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>'talk'),$_smarty_tpl);?>
<?php $_tmp2=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>'talk'),$_smarty_tpl);?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>'talk'),$_smarty_tpl);?>
<?php $_tmp4=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>'talk'),$_smarty_tpl);?>
<?php $_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['layoutNav'] = new Smarty_variable(array(array('hook'=>'talk','activeItem'=>$_smarty_tpl->tpl_vars['sMenuSubItemSelect']->value,'items'=>array(array('name'=>'inbox','url'=>$_tmp1,'text'=>$_smarty_tpl->tpl_vars['aLang']->value['talk']['nav']['inbox']),array('name'=>'new','url'=>$_tmp2."inbox/new/",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['talk']['nav']['new'],'count'=>$_smarty_tpl->tpl_vars['iUserCurrentCountTalkNew']->value,'is_enabled'=>$_smarty_tpl->tpl_vars['iUserCurrentCountTalkNew']->value),array('name'=>'add','url'=>$_tmp3."add/",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['talk']['nav']['add']),array('name'=>'favourites','url'=>$_tmp4."favourites/",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['talk']['nav']['favourites'],'count'=>$_smarty_tpl->tpl_vars['iCountTalkFavourite']->value),array('name'=>'blacklist','url'=>$_tmp5."blacklist/",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['talk']['nav']['blacklist'])))), null, 0);?>
...
">
    ...
    <?php echo $_smarty_tpl->tpl_vars['aLang']->value['talk']['title'];?>
...
?>
    ...
    <?php echo smarty_function_component(array('_default_short'=>'talk','template'=>'search-form'),$_smarty_tpl);?>

    <?php echo smarty_function_component(array('_default_short'=>'talk','template'=>'list','talks'=>$_smarty_tpl->tpl_vars['talks']->value,'paging'=>$_smarty_tpl->tpl_vars['paging']->value,'selectable'=>true),$_smarty_tpl);?>
