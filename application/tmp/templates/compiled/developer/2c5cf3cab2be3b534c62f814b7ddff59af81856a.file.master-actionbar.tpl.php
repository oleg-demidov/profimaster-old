...
<?php /*%%SmartyHeaderCode:5896359575aac030fb57789-12344680%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '5896359575aac030fb57789-12344680',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5aac030fb76834_59173260',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aac030fb76834_59173260')) {function content_5aac030fb76834_59173260($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
$_smarty_tpl->tpl_vars['aItems']->value[] = array('buttons'=>array(array('icon'=>'envelope-o','text'=>'Написать','url'=>$_tmp1."?talk_recepient_id=".((string)$_smarty_tpl->tpl_vars['oMaster']->value->getId()))));?>
    <?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value->isEmployer()){?>
        <?php ob_start();?><?php echo smarty_function_router(array('page'=>"order/add/?master_id=".((string)$_smarty_tpl->tpl_vars['oMaster']->value->getId())),$_smarty_tpl);?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('aItems', null, 0);
$_smarty_tpl->tpl_vars['aItems']->value[] = array('buttons'=>array(array('icon'=>'file-text','mods'=>'success','text'=>'Предложить заказ','url'=>$_tmp2)));?>
    <?php }else{ ?>
