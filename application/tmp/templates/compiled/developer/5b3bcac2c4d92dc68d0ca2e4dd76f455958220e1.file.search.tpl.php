<?php /* Smarty version Smarty-3.1.13, created on 2018-01-01 16:47:47
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionOrder/search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2487854435a4a11d3a4ed65-23772682%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b3bcac2c4d92dc68d0ca2e4dd76f455958220e1' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionOrder/search.tpl',
      1 => 1513162771,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '2487854435a4a11d3a4ed65-23772682',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4a11d3b426f0_66187308',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4a11d3b426f0_66187308')) {function content_5a4a11d3b426f0_66187308($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php $_tmp7=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['aItems'] = new Smarty_variable(array(array('html'=>$_tmp2),array('text'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['freelancer']['menu']['orders'],'classes'=>"fl-nav-item",'url'=>$_tmp3,'name'=>'order_search'),array('text'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['freelancer']['menu']['masters'],'classes'=>"fl-nav-item",'url'=>$_tmp4,'name'=>'master_search'),array('text'=>"Информация",'classes'=>"fl-nav-item",'url'=>$_tmp5,'name'=>'info'),array('text'=>"Сообщество",'classes'=>"fl-nav-item",'url'=>$_tmp6,'name'=>'blog'),array('html'=>$_tmp7)), null, 0);?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['layoutShowSidebar']->value){?>layout-has-sidebar<?php }else{ ?>layout-no-sidebar<?php }?>">
    ...
    <?php echo smarty_insert_block(array('block' => "search", 'params' => array('plugin'=>'freelancer','entity'=>'PluginFreelancer_ModuleOrder_EntityOrder')),$_smarty_tpl);?>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>
        <?php $_smarty_tpl->tpl_vars['oTarget'] = new Smarty_variable($_smarty_tpl->tpl_vars['aOrders']->value[0], null, 0);?>
    <?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo smarty_function_component(array('_default_short'=>"freelancer:order.order-list",'aOrders'=>$_smarty_tpl->tpl_vars['aOrders']->value),$_smarty_tpl);?>
