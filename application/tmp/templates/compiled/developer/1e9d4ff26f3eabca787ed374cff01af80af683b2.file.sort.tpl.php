<?php /* Smarty version Smarty-3.1.13, created on 2018-03-14 14:33:00
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/components/search/sort.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16479585185aa8de3c7bb2f4-80639301%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1e9d4ff26f3eabca787ed374cff01af80af683b2' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/components/search/sort.tpl',
      1 => 1501934443,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '16479585185aa8de3c7bb2f4-80639301',
  'function' => 
  array (
  ...
  'unifunc' => 'content_5aa8de3c81ff09_94417221',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aa8de3c81ff09_94417221')) {function content_5aa8de3c81ff09_94417221($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php $_smarty_tpl->tpl_vars['component_sort'] = new Smarty_variable("fl-search-sort", null, 0);?>
<?php echo smarty_function_component_define_params(array('params'=>array('orderItems')),$_smarty_tpl);?>
...
-holder">
    ...
    <?php $_smarty_tpl->tpl_vars['buttons'] = new Smarty_variable(array(), null, 0);?>
    <?php  $_smarty_tpl->tpl_vars['Item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['Item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['orderItems']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['Item']->key => $_smarty_tpl->tpl_vars['Item']->value){
$_smarty_tpl->tpl_vars['Item']->_loop = true;
?>
        <?php if ($_smarty_tpl->tpl_vars['Item']->value['value']){?>
            <?php echo smarty_function_component(array('_default_short'=>'field.hidden','classes'=>((string)$_smarty_tpl->tpl_vars['component_sort']->value)."-hidden",'name'=>$_smarty_tpl->tpl_vars['Item']->value['name'],'value'=>$_smarty_tpl->tpl_vars['Item']->value['value']),$_smarty_tpl);?>

        <?php }?>
        <?php $_smarty_tpl->tpl_vars['icon'] = new Smarty_variable($_smarty_tpl->tpl_vars['Item']->value['value'] ? "sort-amount-".((string)$_smarty_tpl->tpl_vars['Item']->value['value']) : "random", null, 0);?>
        <?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['Item']->value['value'];?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['Item']->value['text'];?>
<?php $_tmp2=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('buttons', null, 0);
$_smarty_tpl->tpl_vars['buttons']->value[] = array('icon'=>$_smarty_tpl->tpl_vars['icon']->value,'value'=>$_tmp1,'attributes'=>array('name_hid'=>$_smarty_tpl->tpl_vars['Item']->value['name']),'text'=>$_tmp2,'type'=>'button','classes'=>((string)$_smarty_tpl->tpl_vars['component_sort']->value)."-button");?>
    <?php } ?>
    <?php echo smarty_function_component(array('_default_short'=>'button','template'=>'group','classes'=>((string)$_smarty_tpl->tpl_vars['component_sort']->value)."-buttons",'buttons'=>$_smarty_tpl->tpl_vars['buttons']->value),$_smarty_tpl);?>
