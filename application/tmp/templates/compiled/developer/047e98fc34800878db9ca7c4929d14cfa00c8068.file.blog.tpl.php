<?php /* Smarty version Smarty-3.1.13, created on 2017-12-29 17:58:30
         compiled from "/var/www/profimaster/application/frontend/skin/developer/actions/ActionBlog/blog.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3154494175a462de688e2b1-11495717%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '047e98fc34800878db9ca7c4929d14cfa00c8068' => 
    array (
      0 => '/var/www/profimaster/application/frontend/skin/developer/actions/ActionBlog/blog.tpl',
      1 => 1493631808,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3154494175a462de688e2b1-11495717',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a462de6962227_33223313',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a462de6962227_33223313')) {function content_5a462de6962227_33223313($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['sNavTopicsSubUrl'] = new Smarty_variable($_tmp1, null, 0);?>
        <?php }?>
        <?php ob_start();?><?php echo smarty_function_lang(array('name'=>'blog.menu.all_good'),$_smarty_tpl);?>
<?php $_tmp2=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'blog.menu.all_new'),$_smarty_tpl);?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'blog.menu.all_discussed'),$_smarty_tpl);?>
<?php $_tmp4=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('name'=>'blog.menu.all_top'),$_smarty_tpl);?>
<?php $_tmp5=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('layoutNav', null, 0);
$_smarty_tpl->tpl_vars['layoutNav']->value[] = array('hook'=>'topics_sub','activeItem'=>$_smarty_tpl->tpl_vars['sMenuSubItemSelect']->value,'items'=>array(array('name'=>'good','url'=>$_smarty_tpl->tpl_vars['sNavTopicsSubUrl']->value,'text'=>$_tmp2),array('name'=>'new','url'=>((string)$_smarty_tpl->tpl_vars['sNavTopicsSubUrl']->value)."newall/",'text'=>$_tmp3),array('name'=>'discussed','url'=>((string)$_smarty_tpl->tpl_vars['sNavTopicsSubUrl']->value)."discussed/",'text'=>$_tmp4),array('name'=>'top','url'=>((string)$_smarty_tpl->tpl_vars['sNavTopicsSubUrl']->value)."top/",'text'=>$_tmp5)));?>
...
<?php $_tmp6=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('_default_short'=>'blog.menu.top_period_7'),$_smarty_tpl);?>
<?php $_tmp7=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('_default_short'=>'blog.menu.top_period_30'),$_smarty_tpl);?>
<?php $_tmp8=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_lang(array('_default_short'=>'blog.menu.top_period_all'),$_smarty_tpl);?>
<?php $_tmp9=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('layoutNav', null, 0);
$_smarty_tpl->tpl_vars['layoutNav']->value[] = array('hook'=>'topics_sub_timespan','activeItem'=>$_smarty_tpl->tpl_vars['periodSelectCurrent']->value,'items'=>array(array('text'=>htmlspecialchars($_smarty_tpl->tpl_vars['periodSelectCurrentTitle']->value, ENT_QUOTES, 'UTF-8', true),'menu'=>array('activeItem'=>$_smarty_tpl->tpl_vars['periodSelectCurrent']->value,'items'=>array(array('name'=>'1','url'=>((string)$_smarty_tpl->tpl_vars['periodSelectRoot']->value)."?period=1",'text'=>$_tmp6),array('name'=>'7','url'=>((string)$_smarty_tpl->tpl_vars['periodSelectRoot']->value)."?period=7",'text'=>$_tmp7),array('name'=>'30','url'=>((string)$_smarty_tpl->tpl_vars['periodSelectRoot']->value)."?period=30",'text'=>$_tmp8),array('name'=>'all','url'=>((string)$_smarty_tpl->tpl_vars['periodSelectRoot']->value)."?period=all",'text'=>$_tmp9))))));?>
        <?php }?>
    <?php }?>
