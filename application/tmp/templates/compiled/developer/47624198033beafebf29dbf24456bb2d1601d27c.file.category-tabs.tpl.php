<?php /* Smarty version Smarty-3.1.13, created on 2018-03-14 23:58:38
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/components/category-tabs/category-tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5915551195aa962ce452074-52422736%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '47624198033beafebf29dbf24456bb2d1601d27c' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/components/category-tabs/category-tabs.tpl',
      1 => 1521050316,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '5915551195aa962ce452074-52422736',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5aa962ce4a66b5_58989330',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aa962ce4a66b5_58989330')) {function content_5aa962ce4a66b5_58989330($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php echo smarty_function_component_define_params(array('params'=>array('activeTab','tabs','mods','classes','attributes','classesList')),$_smarty_tpl);?>
    ...
    <?php echo smarty_function_component_define_params(array('params'=>array('categories','categoriesSelected')),$_smarty_tpl);?>
...
$_smarty_tpl->tpl_vars['tab']->value['text'] = $_smarty_tpl->tpl_vars['categoryLevel0']->value->getTitle();?>
...
?>
                <div class="categories-block"><?php echo smarty_function_component(array('_default_short'=>'field.checkbox','classes'=>"parent-item",'attributes'=>array('data-parent-id'=>$_smarty_tpl->tpl_vars['categoryLevel0']->value->getId()),'label'=>$_smarty_tpl->tpl_vars['categoryLevel1']->value->getTitle(),'value'=>$_smarty_tpl->tpl_vars['categoryLevel1']->value->getId()),$_smarty_tpl);?>
...
?><?php echo smarty_function_component(array('_default_short'=>'field.checkbox','classes'=>"child-item",'attributes'=>array('data-parent-id'=>$_smarty_tpl->tpl_vars['categoryLevel1']->value->getId()),'label'=>$_smarty_tpl->tpl_vars['categoryLevel2']->value->getTitle(),'value'=>$_smarty_tpl->tpl_vars['categoryLevel2']->value->getId()),$_smarty_tpl);?>
<?php } ?></div>
            <?php } ?>
