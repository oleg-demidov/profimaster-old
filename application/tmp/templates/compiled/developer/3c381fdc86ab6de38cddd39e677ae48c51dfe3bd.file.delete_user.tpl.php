<?php /* Smarty version Smarty-3.1.13, created on 2018-03-20 18:22:46
         compiled from "/var/www/profimaster/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/users/delete_user.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14942286585ab0fd1690be11-03272186%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c381fdc86ab6de38cddd39e677ae48c51dfe3bd' => 
    array (
      0 => '/var/www/profimaster/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/users/delete_user.tpl',
      1 => 1493631928,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '14942286585ab0fd1690be11-03272186',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ab0fd1696c168_12530368',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ab0fd1696c168_12530368')) {function content_5ab0fd1696c168_12530368($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.router.php';
...
?><!doctype html>
    ...
    <?php ob_start();?><?php echo smarty_function_router(array('page'=>'admin/users/profile'),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['layoutBackUrl'] = new Smarty_variable($_tmp1.((string)$_smarty_tpl->tpl_vars['oUser']->value->getId()), null, 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['users']['deleteuser']['title'];?>
 #<?php echo $_smarty_tpl->tpl_vars['oUser']->value->getId();?>
 (<span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oUser']->value->getLogin(), ENT_QUOTES, 'UTF-8', true);?>
</span>, <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['oUser']->value->getMail(), ENT_QUOTES, 'UTF-8', true);?>
)
</h2>
	...
	<?php echo smarty_function_component(array('_default_short'=>'admin:p-user','template'=>'delete','user'=>$_smarty_tpl->tpl_vars['oUser']->value),$_smarty_tpl);?>
