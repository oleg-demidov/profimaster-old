<?php /* Smarty version Smarty-3.1.13, created on 2018-03-19 11:44:48
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/components/field/category-tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:553193175aaf4e50063423-37107835%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75bc74374caf9a85b537a33855c5e3283efe6c62' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/components/field/category-tree.tpl',
      1 => 1519389882,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '553193175aaf4e50063423-37107835',
  'function' => 
  array (
  ...
  'unifunc' => 'content_5aaf4e500ee105_58689025',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aaf4e500ee105_58689025')) {function content_5aaf4e500ee105_58689025($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['value'] = new Smarty_variable((($tmp = @$_tmp1)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['value']->value : $tmp), null, 0);?>
    ...
    <?php echo smarty_function_component_define_params(array('params'=>array('aCategories','categoriesSelected','params','mods','classes','attributes','url')),$_smarty_tpl);?>

    
    <?php $_smarty_tpl->tpl_vars['categoriesSelectedId'] = new Smarty_variable(array(), null, 0);?>
    <?php  $_smarty_tpl->tpl_vars['categorySelected'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['categorySelected']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['categoriesSelected']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['categorySelected']->key => $_smarty_tpl->tpl_vars['categorySelected']->value){
$_smarty_tpl->tpl_vars['categorySelected']->_loop = true;
?>
        <?php $_smarty_tpl->createLocalArrayVariable('categoriesSelectedId', null, 0);
$_smarty_tpl->tpl_vars['categoriesSelectedId']->value[] = $_smarty_tpl->tpl_vars['categorySelected']->value->getId();?>
    <?php } ?>
    
    <?php $_smarty_tpl->tpl_vars['categorySelected'] = new Smarty_variable(end($_smarty_tpl->tpl_vars['categoriesSelected']->value), null, 0);?>
    
    <?php if ($_smarty_tpl->tpl_vars['categorySelected']->value){?>
        <?php $_smarty_tpl->tpl_vars['chooseName'] = new Smarty_variable($_smarty_tpl->tpl_vars['categorySelected']->value->getTitle(), null, 0);?>
        <?php $_smarty_tpl->tpl_vars['chooseId'] = new Smarty_variable($_smarty_tpl->tpl_vars['categorySelected']->value->getId(), null, 0);?>
        <?php $_smarty_tpl->tpl_vars['chooseUrlFull'] = new Smarty_variable($_smarty_tpl->tpl_vars['categorySelected']->value->getUrlFull(), null, 0);?>
    <?php }?>
    
    <?php $_smarty_tpl->tpl_vars['levelItems'] = new Smarty_variable(array(), null, 0);?>
...
?>
        <?php $_smarty_tpl->createLocalArrayVariable('levelItems', null, 0);
$_smarty_tpl->tpl_vars['levelItems']->value[$_smarty_tpl->tpl_vars['aCategory']->value['parent_id']][] = $_smarty_tpl->tpl_vars['aCategory']->value;?>
        
    <?php } ?>
    
    <?php $_smarty_tpl->tpl_vars['classes'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['classes']->value)." fl-category-tree js-category-tree", null, 0);?>
...
-holder">
    ...
    <div class="<?php echo $_smarty_tpl->tpl_vars['component']->value;?>
-icon"><?php echo smarty_function_component(array('_default_short'=>'icon','icon'=>"bars"),$_smarty_tpl);?>
</div>
    <div class="input-close-but" >X</div>
    <input type="text" class="<?php echo $_smarty_tpl->tpl_vars['component']->value;?>
-input <?php echo $_smarty_tpl->tpl_vars['component']->value;?>
-category-input js-field-category" 
            placeholder="<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['freelancer']['field_category']['placeholder'];?>
"
           value="<?php echo $_smarty_tpl->tpl_vars['chooseName']->value;?>
" data-show-dropdown="<?php echo $_smarty_tpl->tpl_vars['showDropdown']->value;?>
" autocomplete="off">
    <?php if ($_smarty_tpl->tpl_vars['chooseId']->value){?>
        <input type="hidden" name="categories[]" value="<?php echo $_smarty_tpl->tpl_vars['chooseId']->value;?>
" class="appended-category appended-category-id" />
        <input type="hidden" name="category_url_full" value="<?php echo $_smarty_tpl->tpl_vars['chooseUrlFull']->value;?>
" class="appended-category appended-category-url" />
    <?php }?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['aItems'] = new Smarty_variable(array(array("text"=>$_tmp1,"classes"=>'ls-loading')), null, 0);?> 
    ...
    <?php echo smarty_function_component(array('_default_short'=>'dropdown.menu','text'=>'Выбрать','items'=>$_smarty_tpl->tpl_vars['aItems']->value,'isSubnav'=>true,'classes'=>"js-category-tree-dropdown"),$_smarty_tpl);?>

    <?php echo smarty_function_component(array('_default_short'=>'dropdown.menu','text'=>'Выбрать','items'=>$_smarty_tpl->tpl_vars['aItems']->value,'isSubnav'=>true,'classes'=>"js-category-find-dropdown"),$_smarty_tpl);?>

    
    <div class="preparations" style="display:none;">
        <?php  $_smarty_tpl->tpl_vars['alevelMenu'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['alevelMenu']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['levelItems']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['alevelMenu']->key => $_smarty_tpl->tpl_vars['alevelMenu']->value){
$_smarty_tpl->tpl_vars['alevelMenu']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['alevelMenu']->key;
?>
            <?php $_smarty_tpl->tpl_vars['aItems'] = new Smarty_variable(array(), null, 0);?>
            <?php  $_smarty_tpl->tpl_vars['alevelItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['alevelItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['alevelMenu']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['alevelItem']->key => $_smarty_tpl->tpl_vars['alevelItem']->value){
$_smarty_tpl->tpl_vars['alevelItem']->_loop = true;
?>
                <?php $_smarty_tpl->tpl_vars['bSelected'] = new Smarty_variable(in_array($_smarty_tpl->tpl_vars['alevelItem']->value['entity']->getId(),$_smarty_tpl->tpl_vars['categoriesSelectedId']->value), null, 0);?>
                <?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['bSelected']->value){?><?php echo "selected";?><?php }?><?php $_tmp2=ob_get_clean();?><?php ob_start();?><?php echo mb_strtolower($_smarty_tpl->tpl_vars['alevelItem']->value['entity']->getTitle(), 'UTF-8');?>
<?php $_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['aItem'] = new Smarty_variable(array('text'=>$_smarty_tpl->tpl_vars['alevelItem']->value['entity']->getTitle(),'classes'=>$_tmp2,'attributes'=>array('data-url-full'=>$_smarty_tpl->tpl_vars['alevelItem']->value['entity']->getUrlFull(),'data-id'=>$_smarty_tpl->tpl_vars['alevelItem']->value['entity']->getId(),'valuelo'=>$_tmp3,'value'=>$_smarty_tpl->tpl_vars['alevelItem']->value['entity']->getTitle()),'url'=>((string)$_smarty_tpl->tpl_vars['url']->value).((string)$_smarty_tpl->tpl_vars['alevelItem']->value['entity']->getUrlFull())), null, 0);?>
                <?php if ($_smarty_tpl->tpl_vars['alevelItem']->value['children_count']){?>
                    <?php $_smarty_tpl->createLocalArrayVariable('aItem', null, 0);
$_smarty_tpl->tpl_vars['aItem']->value['menu'] = array('items'=>array(array()));?>
                <?php }?>
                <?php $_smarty_tpl->createLocalArrayVariable('aItems', null, 0);
$_smarty_tpl->tpl_vars['aItems']->value[] = $_smarty_tpl->tpl_vars['aItem']->value;?>
            <?php } ?>
            
            <?php $_smarty_tpl->tpl_vars['attr'] = new Smarty_variable(array('data-parent-id'=>0), null, 0);?>
            <?php if ($_smarty_tpl->tpl_vars['key']->value){?>
                <?php $_smarty_tpl->tpl_vars['attr'] = new Smarty_variable(array('data-parent-id'=>$_smarty_tpl->tpl_vars['key']->value), null, 0);?>
            <?php }?>
            <?php echo smarty_function_component(array('_default_short'=>'nav','items'=>$_smarty_tpl->tpl_vars['aItems']->value,'attributes'=>$_smarty_tpl->tpl_vars['attr']->value,'isSubnav'=>true,'mods'=>'stacked'),$_smarty_tpl);?>
<br>
