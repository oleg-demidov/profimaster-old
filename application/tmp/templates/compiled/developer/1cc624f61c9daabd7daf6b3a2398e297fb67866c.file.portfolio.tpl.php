<?php /* Smarty version Smarty-3.1.13, created on 2018-03-20 18:36:45
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionUser/portfolio.tpl" */ ?>
<?php /*%%SmartyHeaderCode:448543905ab1005de1fda5-07840760%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1cc624f61c9daabd7daf6b3a2398e297fb67866c' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionUser/portfolio.tpl',
      1 => 1509165426,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '448543905ab1005de1fda5-07840760',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ab1005dedbcb6_36660754',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ab1005dedbcb6_36660754')) {function content_5ab1005dedbcb6_36660754($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value&&$_smarty_tpl->tpl_vars['oUserCurrent']->value->getId()==$_smarty_tpl->tpl_vars['oUser']->value->getId()){?>
        <?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value->isCreatePortfolio()){?>
            <?php ob_start();?><?php echo smarty_function_router(array('page'=>"portfolio/work/add"),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'button','type'=>"button",'url'=>$_tmp1,'text'=>"Добавить работу"),$_smarty_tpl);?>

        <?php }else{ ?>
            <?php echo smarty_function_component(array('_default_short'=>'freelancer:market','text'=>"Добавить работу"),$_smarty_tpl);?>

        <?php }?>
    <?php }?>
    <?php if (!sizeof($_smarty_tpl->tpl_vars['aWorks']->value)){?>
        <?php echo smarty_function_component(array('_default_short'=>'blankslate','title'=>"Работ нет"),$_smarty_tpl);?>

    <?php }?>
    <?php echo Smarty::$_smarty_vars['capture']['paging'];?>

    <?php echo smarty_function_component(array('_default_short'=>'freelancer:portfolio.work.list','aWorks'=>$_smarty_tpl->tpl_vars['aWorks']->value),$_smarty_tpl);?>
