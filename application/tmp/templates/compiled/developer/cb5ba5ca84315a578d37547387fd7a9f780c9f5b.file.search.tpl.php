<?php /* Smarty version Smarty-3.1.13, created on 2018-01-04 20:44:25
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionUser/search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5613542645a4e3dc9f37c16-83963203%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cb5ba5ca84315a578d37547387fd7a9f780c9f5b' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionUser/search.tpl',
      1 => 1513159326,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '5613542645a4e3dc9f37c16-83963203',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4e3dca0a9116_54218663',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4e3dca0a9116_54218663')) {function content_5a4e3dca0a9116_54218663($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php $_tmp7=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['aItems'] = new Smarty_variable(array(array('html'=>$_tmp2),array('text'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['freelancer']['menu']['orders'],'classes'=>"fl-nav-item",'url'=>$_tmp3,'name'=>'order_search'),array('text'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['freelancer']['menu']['masters'],'classes'=>"fl-nav-item",'url'=>$_tmp4,'name'=>'master_search'),array('text'=>"Информация",'classes'=>"fl-nav-item",'url'=>$_tmp5,'name'=>'info'),array('text'=>"Сообщество",'classes'=>"fl-nav-item",'url'=>$_tmp6,'name'=>'blog'),array('html'=>$_tmp7)), null, 0);?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['layoutShowSidebar']->value){?>layout-has-sidebar<?php }else{ ?>layout-no-sidebar<?php }?>">
    ...
    <?php echo smarty_insert_block(array('block' => "search", 'params' => array('plugin'=>'freelancer','entity'=>'User_User')),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo smarty_function_component(array('_default_short'=>"freelancer:master.list",'aMasters'=>$_smarty_tpl->tpl_vars['aFreelancers']->value),$_smarty_tpl);?>

    <?php ob_start();?><?php echo sizeof($_smarty_tpl->tpl_vars['aFreelancers']->value);?>
<?php $_tmp1=ob_get_clean();?><?php if (!$_tmp1){?>
        <?php echo smarty_function_component(array('_default_short'=>'blankslate','title'=>"Резултатов нет"),$_smarty_tpl);?>
