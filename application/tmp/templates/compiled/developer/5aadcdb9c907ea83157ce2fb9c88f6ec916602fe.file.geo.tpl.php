<?php /* Smarty version Smarty-3.1.13, created on 2018-01-04 21:35:44
         compiled from "/var/www/profimaster/application/plugins/ydirect/frontend/skin/default/components/geo/geo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17661019345a4e49d09a04b0-49820486%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5aadcdb9c907ea83157ce2fb9c88f6ec916602fe' => 
    array (
      0 => '/var/www/profimaster/application/plugins/ydirect/frontend/skin/default/components/geo/geo.tpl',
      1 => 1501706067,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '17661019345a4e49d09a04b0-49820486',
  'function' => 
  array (
  ...
  'unifunc' => 'content_5a4e49d09f6d88_60746120',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4e49d09f6d88_60746120')) {function content_5a4e49d09f6d88_60746120($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<?php echo smarty_function_component_define_params(array('params'=>array('label','aGeoItems','selectedItem')),$_smarty_tpl);?>
...
<?php  $_smarty_tpl->tpl_vars['oGeoItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['oGeoItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['aGeoItems']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['oGeoItem']->key => $_smarty_tpl->tpl_vars['oGeoItem']->value){
$_smarty_tpl->tpl_vars['oGeoItem']->_loop = true;
?>
    <?php $_smarty_tpl->createLocalArrayVariable('aItems', null, 0);
$_smarty_tpl->tpl_vars['aItems']->value[] = array('text'=>$_smarty_tpl->tpl_vars['oGeoItem']->value->getGeoRegionName(),'data'=>array('id'=>$_smarty_tpl->tpl_vars['oGeoItem']->value->getId()));?>
<?php } ?>

<?php echo smarty_function_component(array('_default_short'=>'dropdown','icon'=>"globe",'text'=>$_smarty_tpl->tpl_vars['selectedItem']->value->getGeoRegionName(),'classes'=>'ygeo-dropdown','menu'=>$_smarty_tpl->tpl_vars['aItems']->value),$_smarty_tpl);?>

    <input type='hidden' name="ygeo" value=<?php echo $_smarty_tpl->tpl_vars['selectedItem']->value->getId();?>
>
