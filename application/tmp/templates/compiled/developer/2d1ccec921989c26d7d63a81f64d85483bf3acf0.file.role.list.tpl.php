<?php /* Smarty version Smarty-3.1.13, created on 2018-01-04 20:51:59
         compiled from "/var/www/profimaster/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/rbac/role.list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15190969885a4e3f8f816277-64522713%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d1ccec921989c26d7d63a81f64d85483bf3acf0' => 
    array (
      0 => '/var/www/profimaster/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/rbac/role.list.tpl',
      1 => 1493631928,
      2 => 'file',
    ),
    ...
    '173ff098973c288536c724b57ba6149f53dc7824' => 
    array (
      0 => '/var/www/profimaster/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/rbac/menu.tpl',
      1 => 1493631928,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15190969885a4e3f8f816277-64522713',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4e3f8f896b68_46495356',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4e3f8f896b68_46495356')) {function content_5a4e3f8f896b68_46495356($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.router.php';
...
<div id="container" class=" <?php if ($_smarty_tpl->tpl_vars['bNoSidebar']->value){?>no-sidebar<?php }?>">
	...
	<?php ob_start();?><?php echo smarty_function_router(array('page'=>"admin/users/rbac/role-create"),$_smarty_tpl);?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('./menu.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '15190969885a4e3f8f816277-64522713');
content_5a4e3f8f8659c0_93543684($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "./menu.tpl" */?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<?php echo smarty_function_component(array('_default_short'=>'admin:p-rbac','template'=>'role-list','roles'=>$_smarty_tpl->tpl_vars['aRoleItems']->value),$_smarty_tpl);?>
...
<?php }} ?><?php /* Smarty version Smarty-3.1.13, created on 2018-01-04 20:51:59
         compiled from "/var/www/profimaster/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/rbac/menu.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5a4e3f8f8659c0_93543684')) {function content_5a4e3f8f8659c0_93543684($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.router.php';
if (!is_callable('smarty_function_component')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component.php';
?><div class="ls-fl-r">
    <?php ob_start();?><?php echo smarty_function_router(array('page'=>"admin/users/rbac/role"),$_smarty_tpl);?>
<?php $_tmp1=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['sMenuSubItemSelect']->value=='role'){?><?php echo "active";?><?php }?><?php $_tmp2=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>"admin/users/rbac/permission"),$_smarty_tpl);?>
<?php $_tmp3=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['sMenuSubItemSelect']->value=='permission'){?><?php echo "active";?><?php }?><?php $_tmp4=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_router(array('page'=>"admin/users/rbac/group"),$_smarty_tpl);?>
<?php $_tmp5=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['sMenuSubItemSelect']->value=='group'){?><?php echo "active";?><?php }?><?php $_tmp6=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'admin:button','template'=>'group','buttons'=>array(array('text'=>'Роли','url'=>$_tmp1,'classes'=>$_tmp2),array('text'=>'Разрешения','url'=>$_tmp3,'classes'=>$_tmp4),array('text'=>'Группы','url'=>$_tmp5,'classes'=>$_tmp6))),$_smarty_tpl);?>
