<?php /* Smarty version Smarty-3.1.13, created on 2018-03-14 20:07:46
         compiled from "/var/www/profimaster/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/users/stats.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16402766585aa92cb281d5c8-55440193%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a0eb315a3f4d9c15cf970c866da65eec625e1f4' => 
    array (
      0 => '/var/www/profimaster/application/plugins/admin/frontend/skin/default/actions/ActionAdmin/users/stats.tpl',
      1 => 1493631928,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '16402766585aa92cb281d5c8-55440193',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5aa92cb288c6a9_61323815',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aa92cb288c6a9_61323815')) {function content_5aa92cb288c6a9_61323815($_smarty_tpl) {?><?php if (!is_callable('smarty_function_router')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.router.php';
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
	...
	<?php echo $_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['users_stats']['title'];?>
...
<?php $_tmp1=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'admin:p-graph','title'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['users_stats']['registrations'],'data'=>$_smarty_tpl->tpl_vars['aDataStats']->value,'name'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['users_stats']['registrations'],'url'=>$_tmp1,'showFilterPeriod'=>true),$_smarty_tpl);?>


	
	<div class="p-dashboard-block-group ls-clearfix">
		<?php echo smarty_function_component(array('_default_short'=>'admin:p-user.block-genders','stats'=>$_smarty_tpl->tpl_vars['aStats']->value),$_smarty_tpl);?>

		<?php echo smarty_function_component(array('_default_short'=>'admin:p-user.block-activity','stats'=>$_smarty_tpl->tpl_vars['aStats']->value,'rating'=>$_smarty_tpl->tpl_vars['aGoodAndBadUsers']->value),$_smarty_tpl);?>

	</div>

	
	<?php echo smarty_function_component(array('_default_short'=>'admin:p-user.chart-age','data'=>$_smarty_tpl->tpl_vars['aBirthdaysStats']->value,'title'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['admin']['users_stats']['age_stats']),$_smarty_tpl);?>


	
	<div id="admin_users_stats_living">
		<?php echo smarty_function_component(array('_default_short'=>'admin:p-user.chart-location','data'=>$_smarty_tpl->tpl_vars['aLivingStats']->value,'total'=>$_smarty_tpl->tpl_vars['aStats']->value['count_all'],'section'=>$_smarty_tpl->tpl_vars['sCurrentLivingSection']->value,'sorting'=>$_smarty_tpl->tpl_vars['sCurrentLivingSorting']->value),$_smarty_tpl);?>
