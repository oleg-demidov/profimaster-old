<?php /* Smarty version Smarty-3.1.13, created on 2018-01-03 17:20:22
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionManager/invites.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10964587465a4cbc764efc01-99229849%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1528506bb77a5d84ee26cd67061f7fc734df3691' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionManager/invites.tpl',
      1 => 1511775984,
      2 => 'file',
    ),
    'a101f0e4dbdbf9a3f3442508e7b92b4eb0732770' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionManager/profile.tpl',
      1 => 1511792802,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10964587465a4cbc764efc01-99229849',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4cbc765f76b0_02526111',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4cbc765f76b0_02526111')) {function content_5a4cbc765f76b0_02526111($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
<br>
    <?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value){?> 
        <?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value->isAdministrator()||$_smarty_tpl->tpl_vars['oUserCurrent']->value->getId()==$_smarty_tpl->tpl_vars['oUserProfile']->value->getId()){?>
        <?php ob_start();?><?php echo Config::Get('plugin.freelancer.market.str_currency');?>
<?php $_tmp1=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'info-list','mods'=>"large",'list'=>array(array('label'=>'Баланс','icon'=>'money','content'=>((string)$_smarty_tpl->tpl_vars['fBalance']->value)." ".$_tmp1))),$_smarty_tpl);?>

        <?php }?>
    <?php }?>
    <?php echo smarty_function_component(array('_default_short'=>'freelancer:manager.invite-but','oUser'=>$_smarty_tpl->tpl_vars['oUserProfile']->value),$_smarty_tpl);?>

    <?php echo smarty_function_component(array('_default_short'=>'freelancer:manager.wall.buttons','oUser'=>$_smarty_tpl->tpl_vars['oUserProfile']->value,'sCurrentPage'=>$_smarty_tpl->tpl_vars['sCurrentPage']->value),$_smarty_tpl);?>
    ...
    <?php ob_start();?><?php echo sizeof($_smarty_tpl->tpl_vars['aUsersInvite']->value);?>
<?php $_tmp1=ob_get_clean();?><?php if (!$_tmp1){?>
        <?php echo smarty_function_component(array('_default_short'=>'blankslate','title'=>"Пусто"),$_smarty_tpl);?>

    <?php }else{ ?>
        <?php echo smarty_function_component(array('_default_short'=>'freelancer:manager.invites','aUsersInvite'=>$_smarty_tpl->tpl_vars['aUsersInvite']->value),$_smarty_tpl);?>
