...
<?php /*%%SmartyHeaderCode:3159502985a4e49ebd2f623-22307687%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3159502985a4e49ebd2f623-22307687',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4e49ebd6b329_49763197',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4e49ebd6b329_49763197')) {function content_5a4e49ebd6b329_49763197($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component.php';
...
<?php $_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['aMenuItems'] = new Smarty_variable(array_merge($_smarty_tpl->tpl_vars['aMenuItems']->value,array(array('icon'=>'envelope-o','name'=>'talk','text'=>$_tmp2,'url'=>$_tmp3,'count'=>$_smarty_tpl->tpl_vars['iUserCurrentCountTalkNew']->value),array('icon'=>'cogs','name'=>'settings','text'=>$_tmp4,'url'=>$_tmp5))), null, 0);?>
...
<?php $_tmp6=ob_get_clean();?><?php ob_start();?><?php echo smarty_function_component(array('_default_short'=>'button','mods'=>"success",'classes'=>((string)$_smarty_tpl->tpl_vars['component']->value)."-addorder",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['freelancer']['menu']['create_order'],'url'=>$_tmp6),$_smarty_tpl);?>
<?php $_tmp7=ob_get_clean();?><?php $_smarty_tpl->createLocalArrayVariable('aMenuItems', null, 0);
$_smarty_tpl->tpl_vars['aMenuItems']->value[] = array('html'=>$_tmp7);?>
        <?php }else{ ?>
...
<?php $_tmp9=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['aMenuItems'] = new Smarty_variable(array_merge($_smarty_tpl->tpl_vars['aMenuItems']->value,array(array('name'=>'-'),array('icon'=>'sign-out','text'=>$_smarty_tpl->tpl_vars['aLang']->value['auth']['logout'],'url'=>$_tmp9."logout/?security_ls_key=".((string)$_smarty_tpl->tpl_vars['LIVESTREET_SECURITY_KEY']->value)))), null, 0);?>
    <?php $_smarty_tpl->tpl_vars['aItems'] = new Smarty_variable(array(array('name'=>'userbar','url'=>((string)$_smarty_tpl->tpl_vars['oUserCurrent']->value->getUserWebPath()),'count'=>((string)$_smarty_tpl->tpl_vars['oUserCurrent']->value->getPro()),'text'=>"<img src=\"".((string)$_smarty_tpl->tpl_vars['oUserCurrent']->value->getProfileAvatarPath(30))."\" alt=\"".((string)$_smarty_tpl->tpl_vars['oUserCurrent']->value->getDisplayName())."\" class=\"".((string)$_smarty_tpl->tpl_vars['component']->value)."-avatar\" /> ".((string)Smarty::$_smarty_vars['capture']['pro']),'menu'=>array('items'=>$_smarty_tpl->tpl_vars['aMenuItems']->value))), null, 0);?>
...
<?php $_tmp11=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['aItems'] = new Smarty_variable(array(array('text'=>$_smarty_tpl->tpl_vars['aLang']->value['auth']['login']['title'],'classes'=>'js-modal-toggle-login','url'=>$_tmp10),array('text'=>$_smarty_tpl->tpl_vars['aLang']->value['auth']['registration']['title'],'classes'=>'js-modal-toggle-registration','url'=>$_tmp11)), null, 0);?>
    <?php }?>
