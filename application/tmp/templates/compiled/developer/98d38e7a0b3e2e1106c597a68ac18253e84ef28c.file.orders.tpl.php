<?php /* Smarty version Smarty-3.1.13, created on 2017-12-29 18:15:55
         compiled from "/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionUser/orders.tpl" */ ?>
<?php /*%%SmartyHeaderCode:554388615a4631fb701173-67058391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '98d38e7a0b3e2e1106c597a68ac18253e84ef28c' => 
    array (
      0 => '/var/www/profimaster/application/plugins/freelancer/frontend/skin/default/actions/ActionUser/orders.tpl',
      1 => 1511865157,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '554388615a4631fb701173-67058391',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a4631fb7c3d16_20417516',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a4631fb7c3d16_20417516')) {function content_5a4631fb7c3d16_20417516($_smarty_tpl) {?><?php if (!is_callable('smarty_function_component_define_params')) include '/var/www/profimaster/framework/classes/modules/viewer/plugs/function.component_define_params.php';
...
?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['oUserCurrent']->value&&$_smarty_tpl->tpl_vars['oUserCurrent']->value->isEmployer()){?>
...
<?php $_tmp1=ob_get_clean();?><?php echo smarty_function_component(array('_default_short'=>'button','mods'=>"success",'classes'=>((string)$_smarty_tpl->tpl_vars['component']->value)."-addorder",'text'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['freelancer']['menu']['create_order'],'url'=>$_tmp1),$_smarty_tpl);?>

        <?php }else{ ?>
            <?php echo smarty_function_component(array('_default_short'=>'freelancer:market','text'=>$_smarty_tpl->tpl_vars['aLang']->value['plugin']['freelancer']['menu']['create_order']),$_smarty_tpl);?>
      
        <?php }?>
    <?php }?>
    <?php $_smarty_tpl->_capture_stack[0][] = array('paging', null, null); ob_start(); ?>
        <?php echo smarty_function_component(array('_default_short'=>'pagination','total'=>+$_smarty_tpl->tpl_vars['paging']->value['iCountPage'],'current'=>+$_smarty_tpl->tpl_vars['paging']->value['iCurrentPage'],'url'=>((string)$_smarty_tpl->tpl_vars['paging']->value['sBaseUrl'])."/page__page__/".((string)$_smarty_tpl->tpl_vars['paging']->value['sGetParams']),'classes'=>'js-pagination-orders'),$_smarty_tpl);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo Smarty::$_smarty_vars['capture']['paging'];?>

    <?php echo smarty_function_component(array('_default_short'=>'freelancer:order.list','aOrders'=>$_smarty_tpl->tpl_vars['aOrders']->value),$_smarty_tpl);?>
